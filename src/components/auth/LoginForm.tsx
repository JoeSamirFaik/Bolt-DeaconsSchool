...
const LoginForm: React.FC<LoginFormProps> = ({ onSwitchToRegister }) => {
  ...
  const demoCredentials = [
    { role: 'شماس', email: 'deacon@example.com', emoji: '🎓', color: 'from-blue-400 to-purple-500' },
    { role: 'خادم', email: 'servant@example.com', emoji: '👨‍🏫', color: 'from-green-400 to-teal-500' },
    { role: 'ولي أمر', email: 'parent@example.com', emoji: '👨‍👩‍👧', color: 'from-pink-400 to-rose-500' },
    { role: 'مدير', email: 'admin@example.com', emoji: '⚡', color: 'from-yellow-400 to-orange-500' },
  ];
