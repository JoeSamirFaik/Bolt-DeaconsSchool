      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-gray-600 font-cairo">عرض جميع الجلسات والأنشطة المجدولة</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="grid grid-cols-7 gap-0">
          {calendarDays.map((day, index) => (
            <div
              key={index}
              className={`min-h-32 border-b border-r border-gray-100 p-2 relative ${
      ...
      {sessions.length === 0 && !loading && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2 font-cairo">لا توجد جلسات مجدولة</h3>
            <p className="text-gray-500 font-cairo">لم يتم جدولة أي جلسات أو فعاليات لهذا الشهر بعد</p>
          </div>
        </div>
      )}
