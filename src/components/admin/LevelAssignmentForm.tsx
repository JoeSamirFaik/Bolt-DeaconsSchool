  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (assignment) {
        ...
        const createData: CreateLevelAssignmentRequest = {
        ...
        await levelAssignmentsApi.create(createData);
      }
      onSave();
    } catch (err) {
          ...
          <div className="flex items-center space-x-3 space-x-reverse">
            <div className="text-right">
              ...
              <p className="text-gray-600 text-sm font-cairo">
                {assignment ? 'قم بتعديل بيانات التكليف' : 'أدخل بيانات التكليف الجديد'}
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                onChange={(selectedOption) => {
                  if (selectedOption) {
                    setFormData({ ...formData, deaconId: selectedOption.value });
                  }
                }}
            ...
            <div>
              ...
              <Select
                ...
                onChange={(selectedOption) => {
                  if (selectedOption) {
                    setFormData({ ...formData, academicYear: selectedOption.value });
                  }
                }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="expectedEndDate" className="block text-sm font-medium text-gray-700 mb-2 text-right">
          ...
          <div className="flex space-x-3 space-x-reverse pt-6 border-t border-gray-200">
            ...
            >
              {loading ? (
                ...
                assignment ? 'تحديث التكليف' : 'إضافة التكليف'
              )}
            </button>
          </div>
        </form>
