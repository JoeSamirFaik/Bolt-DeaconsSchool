      ...
      <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-right">
            <h1 className="text-3xl font-bold text-gray-900 font-cairo mb-2">إدارة الشمامسة وأولياء الأمور</h1>
            <p className="text-gray-600 font-cairo text-lg">إدارة الشمامسة وأولياء الأمور وتكليفات المستويات</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-lg border border-gray-100">
        ...
        {activeTab === 'deacons' && (
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {deacons.map((deacon) => (
                <div key={deacon.id} className="border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className={`px-4 py-2 text-sm font-semibold rounded-full flex items-center space-x-2 space-x-reverse ${
                        ...
                        {deacon.isActive ? <EyeIcon className="w-4 h-4" /> : <EyeSlashIcon className="w-4 h-4" />}
        ...
        {activeTab === 'parents' && (
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {parents.map((parent) => (
                <div key={parent.id} className="border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex space-x-3 space-x-reverse">
                      <button
                        onClick={() => {
                  ...
                  <div className="text-right mb-6">
                    ...
                    <span className="px-4 py-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 text-sm font-semibold rounded-full">
                      ولي أمر
                    </span>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className={`px-4 py-2 text-sm font-semibold rounded-full flex items-center space-x-2 space-x-reverse ${
                        ...
                        {parent.isActive ? <EyeIcon className="w-4 h-4" /> : <EyeSlashIcon className="w-4 h-4" />}
