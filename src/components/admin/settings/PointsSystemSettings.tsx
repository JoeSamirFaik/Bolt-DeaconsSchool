  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse mb-4 sm:mb-6">
        ...
        <h2 className="text-lg sm:text-xl font-bold text-gray-900 font-cairo">إعدادات نظام النقاط</h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-green-50 rounded-xl p-4 sm:p-6 border border-green-200">
          <h3 className="text-base sm:text-lg font-bold text-green-900 mb-3 sm:mb-4 font-cairo">نقاط الأنشطة الدينية</h3>
        ...
        <div className="bg-blue-50 rounded-xl p-4 sm:p-6 border border-blue-200">
          <h3 className="text-base sm:text-lg font-bold text-blue-900 mb-3 sm:mb-4 font-cairo">نقاط التعلم والخدمة</h3>
          <div className="space-y-4">
            <div>
        ...
        <div className="bg-purple-50 rounded-xl p-4 sm:p-6 border border-purple-200">
          <h3 className="text-base sm:text-lg font-bold text-purple-900 mb-3 sm:mb-4 font-cairo">نقاط المكافآت</h3>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-purple-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-right font-cairo text-sm sm:text-base"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-purple-700 mb-2 text-right font-cairo">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-4 sm:p-6 border border-amber-200">
        <h3 className="text-base sm:text-lg font-bold text-amber-900 mb-3 sm:mb-4 font-cairo">معاينة نظام النقاط</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          <div className="bg-white rounded-lg p-3 sm:p-4 text-center shadow-sm">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">⛪</div>
            <div className="text-base sm:text-lg font-bold text-amber-600">{config.liturgyPoints}</div>
            <div className="text-xs sm:text-sm text-gray-600 font-cairo">قداس/صلاة كنسية</div>
          </div>
          <div className="bg-white rounded-lg p-3 sm:p-4 text-center shadow-sm">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">🙏</div>
            <div className="text-base sm:text-lg font-bold text-amber-600">{config.prayerPoints}</div>
            <div className="text-xs sm:text-sm text-gray-600 font-cairo">صلاة شخصية</div>
          </div>
          <div className="bg-white rounded-lg p-3 sm:p-4 text-center shadow-sm">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">📚</div>
            <div className="text-base sm:text-lg font-bold text-amber-600">{config.lessonPoints}</div>
            <div className="text-xs sm:text-sm text-gray-600 font-cairo">درس مكتمل</div>
          </div>
          <div className="bg-white rounded-lg p-3 sm:p-4 text-center shadow-sm">
            <div className="text-xl sm:text-2xl mb-1 sm:mb-2">❤️</div>
            <div className="text-base sm:text-lg font-bold text-amber-600">{config.servicePoints}</div>
            <div className="text-xs sm:text-sm text-gray-600 font-cairo">خدمة مجتمعية</div>
          </div>
        </div>
      </div>
    </div>
